        ...
        <main className="flex-grow py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-serif text-[#5A5A40] mb-4">Delícias Artesanais</h1>
              ...
              <div className="mt-6 inline-block bg-[#5A5A40]/5 px-4 py-2 rounded-lg border border-[#5A5A40]/10">
